...
Порог программной защиты от перегрева и период `slow_pwm` для SSR пока задаются в прошивке. При необходимости они меняются в конфигурации ESPHome с последующей пересборкой прошивки.
