...
- Использовать обратную связь по давлению для профилирования.
- Провести эксперименты с одноканальным RobotDyn AC dimmer для управления мощностью помпы.
- Обновить панель Home Assistant графиками давления и управлением профилями.
